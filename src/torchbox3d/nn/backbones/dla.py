...
from torchbox3d.nn.blocks import (
    AggregationBlock,
    BasicBlock,
    DepthBasicBlock,
    ResidualBlock,
)
from torchbox3d.nn.stems import (
    MetaKernel,
    PointNet,
    RangePartition,
)
...
@dataclass(unsafe_hash=True)
class RangeBackboneIsotropic(nn.Module):
    """Range View Net (based on DLA)."""
...
@dataclass(unsafe_hash=True)
class RangeBackbonePointNet(nn.Module):
    """Range View Net (based on DLA)."""
